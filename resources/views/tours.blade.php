            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="common_bannner_text">
                        <h2 class="text-uppercase">Tour search results</h2>
                        <ul>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="section_heading_center">
                        <h2 class="text-uppercase">38 tours found</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="cruise_search_result_wrapper">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="cruise_item_img">
                                                <img src="/img/tour/tour-list-1.png" alt="img">
                                            </div>
                                        </div>
                                        <div class="col-lg-8">
                                ...
                                <div class="cruise_search_item">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="cruise_item_img">
                                                <img src="/img/tour/tour-list-2.png" alt="img">
                                            </div>
                                        </div>
                                        <div class="col-lg-8">
                                            <div class="cruise_item_inner_content">
                                ...
                                <div class="cruise_search_item">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="cruise_item_img">
                                                <img src="/img/tour/tour-list-3.png" alt="img">
                                            </div>
                                        </div>
                                        <div class="col-lg-8">
                                            <div class="cruise_item_inner_content">
